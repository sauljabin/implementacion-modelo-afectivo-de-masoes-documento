...
\seccion{Prueba se seccion}

\label{primeraSec}

\subseccion{Prueba se subseccion}

\label{segundaSec}

\subsubseccion{Prueba se subsubseccion}

\label{terceraSec}

\refseccion{primeraSec}, \refseccion{segundaSec}

Prueba de referencia múltiple \refseccion{primeraSec, segundaSec, terceraSec} \refpseccion{primeraSec, terceraSec}.

\break

\seccion{Otras pruebas}

\espaciodoble\textbf{Prueba de autocita:}
...
Prueba de referencia múltiple \refalgoritmo{alg, alg, alg} \refpalgoritmo{alg, alg}.
...
Prueba de referencia múltiple \refilustracion{ilustracion, ilustracion, ilustracion} \refpilustracion{ilustracion, ilustracion}.
...
Prueba de referencia múltiple \refgrafico{grafico, grafico, grafico} \refpgrafico{grafico, grafico}.
...
Prueba de referencia múltiple \reflistado{listado, listado, listado} \refplistado{listado, listado}.
...
Prueba de referencia múltiple \refcuadro{ejemplocua,ejemplocua2, ejemplomultirow} \refpcuadro{ejemplocua,ejemplocua2}.
...
Prueba de referencia múltiple \refecuacion{testecuacion, yx, zx} \refpecuacion{testecuacion, distancia-maxima-especifica}.
