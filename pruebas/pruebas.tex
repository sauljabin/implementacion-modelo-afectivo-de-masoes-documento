...
\refilustracion{ilustracion}

\begin{ilustracion}[fuente=Prueba de fuente, etiqueta=ilustracion, titulo=Prueba de ilustracion, indice=Indice de prueba para ilustración]
...
\textbf{Artículo en publicación periódicas (article):}

\verb;\cite{article}; \cite{article}

\textbf{Libros (book):}

\textbf{Capítulo de libro:}

\textbf{Ponencia o presentación en evento científico:}
...
La variable: \codigofuente{int valor = 4;}
